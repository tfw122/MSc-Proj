...
class Middlebury(StereoDataset):
    def __init__(self, config, aug_params=None, root='/data/stereo_data/middlebury', split='train', sub_split='F'):
...
class MiddleburyCustom(StereoDataset):
    def __init__(self, config, aug_params=None, root='/data/stereo_data/middlebury', split='train', sub_split='all'):
